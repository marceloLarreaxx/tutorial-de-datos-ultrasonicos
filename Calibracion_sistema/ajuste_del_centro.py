...
# data_A_scan = np.load(r"C:\MarceloLarrea\utimag_Marcelo\SITAU_GUIs\Alinear_ST1_IV\Datos Alineamiento Array 8x16\A_scan_xy_I.npy")
# euler_angs = np.load(r"C:\MarceloLarrea\utimag_Marcelo\SITAU_GUIs\Alinear_ST1_IV\Datos Alineamiento Array 8x16\A_scan_xy_I_degrees.npy")

# data_A_scan = np.load(r"C:\MarceloLarrea\utimag_Marcelo\SITAU_GUIs\Alinear_ST1_IV\Datos Alineamiento Array 11x11\A_scan_xy_I.npy")
# euler_angs = np.load(r"C:\MarceloLarrea\utimag_Marcelo\SITAU_GUIs\Alinear_ST1_IV\Datos Alineamiento Array 11x11\A_scan_xy_I_degrees.npy")

#----------------------CON SOPORTE NUEVO -------------------------------#
# data_A_scan = np.load(r"C:\MarceloLarrea\utimag_Marcelo\SITAU_GUIs\Alinear_ST1_IV\Datos Alineamiento Array 8x16 (soporte nuevo)\A_scan_xy_I.npy")
# euler_angs = np.load(r"C:\MarceloLarrea\utimag_Marcelo\SITAU_GUIs\Alinear_ST1_IV\Datos Alineamiento Array 8x16 (soporte nuevo)\A_scan_xy_I_degrees.npy")
...
idx_thr = utils.first_thr_cross(data_A_scan, [400, 1000], 50, 10, axis=-1)
...
result_3 = [-5.04469905,  -2, 10.81456065]

x_adjusted = list(x + result_2.x)
delta_tof_corr = ali.calcula_delta_tof_un_elem(list(result_2.x), i_angs0, rot_list)  # tof_calculados a partir de coordenadas corregidas
